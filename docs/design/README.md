...
| [Clipping Plane](proposals/clipping_plane.md) | An arbitrarily oriented clipping plane in the shaders, replacing the near-plane hack. Implemented; kept until its content moves into [rendering.md](rendering.md). |
